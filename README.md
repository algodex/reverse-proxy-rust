...
The basic purpose of this reverse proxy is so that clients can hit the server with large amounts of similar requests and it will handle all of them with low latency and up-to-date response data.
